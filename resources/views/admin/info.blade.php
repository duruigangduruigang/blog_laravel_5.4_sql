...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 系统管理
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            ...
            <li>
                <label>北京时间</label><span>{{date('Y年m月d日 H时:i分:s秒')}}}</span>
            </li>
            <li>
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            <li>
                <label>官方交流网站：</label><span><a href="#">http://www.ggnhs.online</a></span>
            </li>
            <li>
